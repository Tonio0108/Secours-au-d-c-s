...
export default {
  ...
  methods: {
    async countActive() {
      try {
        const res = await axios.get('http://192.168.0.105:3000/api/stat/active');
    ...
    async countRetraite() {
      try {
        const res = await axios.get('http://192.168.0.105:3000/api/stat/retraite');
    ...
    async countDossiers() {
      try {
        const res = await axios.get('http://192.168.0.105:3000/api/stat/secours');
    ...
    try {
      ...
      const response = await fetch('http://192.168.0.105:3000/api/stat/month');
