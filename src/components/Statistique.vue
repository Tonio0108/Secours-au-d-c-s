...
export default {
  ...
  methods: {
    async countActive() {
      try {
        const res = await axios.get('http://192.168.0.10:3000/api/stat/active');
    ...
    async countRetraite() {
      try {
        const res = await axios.get('http://192.168.0.10:3000/api/stat/retraite');
    ...
    async countDossiers() {
      try {
        const res = await axios.get('http://192.168.0.10:3000/api/stat/secours');
    ...
    try {
      ...
      const response = await fetch('http://192.168.0.10:3000/api/stat/month');
      const result = await response.json();
      const response2 = await fetch('http://192.168.0.10:3000/api/stat/month2');
